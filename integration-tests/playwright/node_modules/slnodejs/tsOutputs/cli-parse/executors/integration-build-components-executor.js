...
class IntegrationBuildComponentsExecutor extends base_executor_1.BaseExecutor {
    innerExecute(args, extraArgs) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.backendProxy = backend_proxy_with_default_client_1.BackendProxyFactory.initWithDefaultClient(agentInstanceData, this.baseData, this.logger);
            const components = this.getIntegrationBuildDependenciesFromArgs(args);
            if (components.length > 0) {
                yield this.submitRequest(this.baseData.buildSessionId, components, agentInstanceData.agentId);
                return true;
            }
            else {
