...
exports.iterateSubPathes = exports.FilesContainer = void 0;
...
class FilesContainer {
    ...
    static create(logger, projectRoot = process.cwd(), ignore = "node_modules/**") {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const ignorePatterns = typeof ignore === "string" ? [ignore] : ignore;
            const files = (0, globby_1.sync)("**/*", {
                cwd: projectRoot,
    ...
    addFilePath(filePath) {
        for (const subPath of iterateSubPathes(filePath)) {
            this.partialToFullPathMap[subPath] =
                this.partialToFullPathMap[subPath] || [];
...
exports.iterateSubPathes = iterateSubPathes;
