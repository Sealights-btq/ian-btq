...
class ConfigExecutor extends base_executor_1.BaseExecutor {
    ...
    innerExecute(args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const backendProxy = backend_proxy_with_default_client_1.BackendProxyFactory.initWithDefaultClient(agent_instance_data_1.AgentInstanceDataFactory.getOrCreateAgentInstanceData(), this.baseData, this.logger);
            try {
    ...
    getBuildSessionData(cmd) {
        return __awaiter(this, void 0, void 0, function* () {
            return new build_session_data_builder_1.BuildSessionDataBuilder(this.backendProxy).parseFromCli(cmd);
        });
    }
    mapArgs(args) {
        const data = {
