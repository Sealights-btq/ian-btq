...
Fork of [convert-source-map](https://github.com/thlorenz/convert-source-map) with improved sourcemap parsing.

## Improvements

- Better handling of malformed sourcemap comments
- More robust base64 extraction
- Improved error handling for invalid sourcemaps

## License

MIT, see LICENSE file.

Original work Copyright (c) 2013 Thorsten Lorenz
Modified work Copyright (c) 2024 Sealights
