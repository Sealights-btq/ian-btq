...
class BuildEndExecutor extends base_executor_1.BaseExecutor {
    ...
    innerExecute(args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const backendProxy = backend_proxy_with_default_client_1.BackendProxyFactory.initWithDefaultClient(agentInstanceData, this.baseData, this.logger);
            // labId should not be passed to notifyStart as it tricks the backend into thinking there is a live agent
            const agentConfig = (0, utils_1.createAgentConfig)(this.baseData, true);
            yield cockpit_notifier_1.CockpitNotifier.notifyStart(agentConfig, agentInstanceData, this.logger, system_date_1.getSystemOffset, backendProxy, {});
            try {
