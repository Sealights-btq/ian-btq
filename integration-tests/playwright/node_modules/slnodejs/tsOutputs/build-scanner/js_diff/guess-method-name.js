function guessMethodName(node, anc) {
    var actualName = node.id && node.id.name || node.key && node.key.name;
    if (actualName && ((node.kind == "set") || (node.kind == "get"))) {
        actualName = node.kind + " " + actualName;
    }
...
//# sourceMappingURL=guess-method-name.js.map