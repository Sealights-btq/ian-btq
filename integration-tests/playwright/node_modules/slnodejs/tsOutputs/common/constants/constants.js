...
Constants.SL_CONFIG_VAR = `slConfig`;
Constants.ALLOWED_DOMAINS_CONFIG_PROP_NAME = `allowedDomains`;
Constants.ALLOWED_DOMAINS_CONFIG_PROP = `${Constants.SL_CONFIG_VAR}.${Constants.ALLOWED_DOMAINS_CONFIG_PROP_NAME}`;
