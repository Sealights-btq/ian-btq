...
EntitiesMapper.toServerMethod = function (method) {
    var serverMethod = Object.assign({ uniqueId: method.uniqueId, offsets: method.offsets, endOffset: method.endOffset, displayName: method.srcData.displayName, position: method.srcData.position, endPosition: method.srcData.endPosition, hash: method.srcData.hash, sigHash: method.srcData.sigHash, meta: method.meta, techSpecificInfo: method.techSpecificInfo, idxInMapping: method.idxInMapping }, (method.executableLinesCount >= 0 && { executableLinesCount: method.executableLinesCount }));
    return serverMethod;
};
